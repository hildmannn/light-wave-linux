# light-wave-linux | Una distro Linux optimizada y minimalista (+ paso a paso)
...
## 🛠 Instalación  
1. Descarga la ISO desde este link de Drive: [Releases] (https://github.com/tu-usuario/light-wave-linux/releases).  
